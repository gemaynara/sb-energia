    ...
    <div class="nav-wrap">
        <div class="mobile-only-brand pull-left">
            <div class="nav-header pull-left">
                <div class="logo-wrap">
                    <a href="{{route('home')}}">
                        <img class="brand-img" src="{{asset('imgs/logo.png')}}" alt="brand"/>
                        <span class="brand-text"><img src="{{asset('imgs/logo.png')}}" alt="brand" style="width: 120px !important; padding-top: auto"/></span>
                    </a>
                </div>
            </div>
...
{{--                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="ti-bell top-nav-icon"></i><span--}}
...
{{--                                        <div class="sl-content">--}}
{{--                                            <span--}}
{{--                                                class="inline-block capitalize-font  pull-left truncate head-notifications txt-warning">Server #2 not responding</span>--}}
...
{{--                                        <div class="sl-content">--}}
{{--                                            <span--}}
{{--                                                class="inline-block capitalize-font  pull-left truncate head-notifications">2 new messages</span>--}}
...
{{--                                    <a href="javascript:void(0)">--}}
{{--                                        <div class="sl-avatar">--}}
{{--                                            <img class="img-responsive" src="{{asset('imgs/no-avatar.png')}}" alt="avatar"/>--}}
{{--                                        </div>--}}
{{--                                        <div class="sl-content">--}}
{{--                                            <span--}}
{{--                                                class="inline-block capitalize-font  pull-left truncate head-notifications">Sandy Doe</span>--}}
{{--                                            <span class="inline-block font-11  pull-right notifications-time">1pm</span>--}}
{{--                                            <div class="clearfix"></div>--}}
...
{{--                                        <div class="sl-content">--}}
{{--                                            <span--}}
{{--                                                class="inline-block capitalize-font  pull-left truncate head-notifications txt-danger">99% server space occupied.</span>--}}
{{--                                            <span class="inline-block font-11  pull-right notifications-time">1pm</span>--}}
{{--                                            <div class="clearfix"></div>--}}
...
{{--                </li>--}}
                <li class="dropdown auth-drp">
                    ...
                    <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
                        {{auth()->user()->name }} <img src="{{asset('/imgs/no-avatar.png')}}"
                                                           alt="user_auth"
                        ...
                        <li>
                            <a href="{{ route('logout') }}"
                               onclick="event.preventDefault();
                                ...
                                <i class="zmdi zmdi-power"></i><span>Sair</span></a>
